...
class UnityPanel {
    static createOrShow(extensionUri) {
        ...
        if (UnityPanel.currentPanel) {
            UnityPanel.currentPanel._panel.reveal(column);
            UnityPanel.currentPanel._update();
            return;
        }
        // Otherwise, create a new panel.
        const panel = vscode.window.createWebviewPanel(UnityPanel.viewType, "Unity Panel", column || vscode.ViewColumn.One, {
        ...
        UnityPanel.currentPanel = new UnityPanel(panel, extensionUri);
    }
    static kill() {
        UnityPanel.currentPanel?.dispose();
        UnityPanel.currentPanel = undefined;
    }
    ...
    _getHtmlForWebview(webview) {
        ...
        // vscode.Uri.joinPath(this._extensionUri, "out/complied", "HelloWorld.js")
...
exports.UnityPanel = UnityPanel;
UnityPanel.viewType = "hello-world";
...
const validator = __webpack_require__(5);
const XMLParser = __webpack_require__(7);
const XMLBuilder = __webpack_require__(14);
...
const { buildOptions} = __webpack_require__(8);
const OrderedObjParser = __webpack_require__(9);
const { prettify} = __webpack_require__(13);
const validator = __webpack_require__(5);
...
const readDocType = __webpack_require__(11);
const toNumber = __webpack_require__(12);
...
const buildFromOrderedJs = __webpack_require__(15);
...
class SidebarProvider {
    ...
    _getHtmlForWebview(webview) {
        ...
        const styleMainUri = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, "out", "compiled/vscode.css"));
...
const proxyFromEnv = __webpack_require__(42);
const http = __webpack_require__(24);
const https = __webpack_require__(25);
const util = __webpack_require__(20);
const followRedirects = __webpack_require__(43);
const zlib = __webpack_require__(55);
...
var asynckit = __webpack_require__(31);
...
module.exports =
{
  ...
  serial        : __webpack_require__(39),
  serialOrdered : __webpack_require__(40)
};
...
var defer = __webpack_require__(35);
...
var serialOrdered = __webpack_require__(40);
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __webpack_require__(46)("follow-redirects");
    }
    catch (error) { /* */ }
...
const vscode = __webpack_require__(1);
const UnityPanel_1 = __webpack_require__(2);
const fast_xml_parser_1 = __webpack_require__(4);
const SidebarProvider_1 = __webpack_require__(16);
const axios = (__webpack_require__(17)["default"]);
...
async function activate(context) {
    ...
    const res = await axios.get('https://rss.app/feeds/tjAIn6IyCPzl6J1K.xml');
    ...
    context.subscriptions.push(vscode.commands.registerCommand('learn-unity-scripting.unityLearnDocs', async () => {
        UnityPanel_1.UnityPanel.createOrShow(context.extensionUri);
    ...
    context.subscriptions.push(vscode.window.registerWebviewViewProvider("unity-sidebar", sidebarProvider));
